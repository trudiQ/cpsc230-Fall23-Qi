...
# Rename the file name to "PythonBasics_3_YOURNAME.py" and Submit

# Numbers
'''
Create a random integer and 
...
'''
Create a list consisting items of a string, an integer, a float
and a list.
Print out the list and its type.
'''
list_1 = ['Today is', 2023, 9.11, [1, 2, 3]]
