...
e) Add a new item to the inventory called "pears" with a quantity of 10 and print it.
...
e) Add a new item to the inventory called "pears" with a quantity of 10 and print it. Use update()
