...
'''
2. Create a dictionary variable named student 1 to store the name, age, and major, of a random Chapman Student.
'''
# your code here
...
3 Without using Python, figure out the answer to this statement.
    Explain in your report the order of operations.
...
'''
4. Using your operators (%,/,//,*), write some code to convert an amount of
...
Hint: Starting from getting input minutes from the user using statement
    mins_input = int(input()). Your code should then convert mins_input into 
    two variables, X and Y, reprsenting hours and minutes respectively using 
    operators %, /, //, *.

Print out the numbers of hours and minutes in the form "X hours, Y minutes".
